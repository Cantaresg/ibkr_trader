"""
v7a sweep: RPPO with 20 features (momentum_5d/20d, macd_hist, ma20d_dev).
Compares v6 baseline result (stored) vs v7a checkpoints across training steps.
"""
import sys
sys.path.insert(0, ".")
...
BASE = "intraday_trader/checkpoints/intraday_rppo_v7a"

NAMED = [
    ("v7a RPPO best",      f"{BASE}/best/best_model.zip"),
    ("v7a RPPO final [5M]", f"{BASE}/final_model.zip"),
]

# Coarse sweep to find peak, then fine-grained around it
SWEEP_STEPS = [
